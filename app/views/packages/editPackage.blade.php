...
<h1 data-icon="cube" class="pull-left"><a href="{{ route('packages') }}">Packages</a>:: <small>Edit Package</small></h1>
</div>
<div class="stickyContainer">

    	{{ Form::open(array('url' => 'view-packages/edit', 'class' => 'form-horizontal')) }}
	<section>
        <div class="row">
        		<h3>Package Info</h3>
        		<div class="col-sm-4">
