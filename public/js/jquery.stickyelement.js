;(function($, window, undefined) {
    ...
    Sticky.prototype.moveIt = function() {
       ...
       var scrollTop = $(window).scrollTop()+this.options.startOffset;
		//var scrollTop = $(window).scrollTop();
       var height = this.element.outerHeight(true)+this.options.stopOffset;
        ...
        if (this._parentHeight - this._offset > height && !this._frozen) {
            if (scrollTop >= this._start && scrollTop <= realStop) {
                if(this.options.useFixed){
                    this.element.css({'position':'fixed','top':this.options.offset,'left':this.element.offset().left});
                } else {
